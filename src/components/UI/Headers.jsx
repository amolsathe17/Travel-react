  ...
  return (
    <div>
                ...
                {profileOpen && (
                  <motion.div variants={dropdownVariants} initial="hidden" animate="visible" exit="exit"
                    ...
                    <ul className="space-y-2 text-sm">
                      <li className={submenuItemClass} cursor-pointer><User size={16}/><NavLink to="/Profile"> My Profile</NavLink></li>
                      <li className={submenuItemClass} cursor-pointer><Settings size={16}/><NavLink to="/Settings"> Settings</NavLink></li>
                      <li className={submenuItemClass} cursor-pointer><LogOut size={16}/> <NavLink to="/"> Logout</NavLink></li>
                    </ul>
                  </motion.div>
                )}
              </AnimatePresence>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="fixed inset-0 bg-black/90 backdrop-blur-lg z-50 p-6 text-white"
              ...
              <div className="mb-6 border-b border-white/20 pb-4">
                ...
                <AnimatePresence>
                  {mobileProfileOpen && (
                    ...
                    >
                      <button className="flex items-center gap-2 cursor-pointer"><User size={16}/><NavLink to="/Profile"> My Profile</NavLink></button>
                      <button className="flex items-center gap-2" cursor-pointer><Settings size={16}/><NavLink to="/Settings"> Settings</NavLink></button>
                      <button className="flex items-center gap-2 cursor-pointer"><LogOut size={16}/><NavLink to="/"> Logout</NavLink></button>
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
