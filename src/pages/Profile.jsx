...
export default function Profile() {
  ...
  return (
    <div className="h-140 relative flex items-center justify-center p-6 bg-linear-to-br from-slate-950 via-slate-900 to-slate-800">
      ...
      <div className="relative z-10 w-full max-w-4xl bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-6 md:p-10 md:mt-20">
